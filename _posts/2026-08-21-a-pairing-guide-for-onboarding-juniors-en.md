...
That's why, when you work with juniors, **how you teach them** still matters just as much, even with Claude Code or Codex in front of you.  
The tool changes but the knowledge transfer doesn't.
...
It's one of the twelve Extreme Programming practices, and in [*software economics* by Luis Artola](https://leanpub.com/software-economics) terms it's one of the most powerful risk management tools we have: it creates options, reduces complexity and raises the bus factor.
...
Neither one wins the race alone.
...
- **Neither role is the senior one.** It's a split of tasks, not a hierarchy. Juniors navigate too.
- **The navigator isn't proofreading.** Pairing *is* review, and that's what saves you the review afterwards: two people agreed on this code while it was being written, not two days later. But you review decisions, not keystrokes. A missing semicolon is for the compiler.
- **The driver isn't a typist.** You aren't taking dictation. If you don't understand what you're typing, stop and ask. You're the one who will have to explain this code tomorrow.
- **The navigator isn't resting.** Not typing isn't watching. If you go quiet for ten minutes, there's one person in the session, not two.

The navigator is free to think because they're free from typing, and that's the whole reason there are two of you.  
Both roles are tiring, in different ways. That's why you swap often.
...
The driver looks at the **how** and the **what**. You look at the **what** and the **why**.  
You only share the middle.
...
- **Keep the goal stack**: the list of what's left until you're done, from the big goal to the step you're on right now. When the driver closes one, you already know which one comes next.
...
- **Learning mode**: we trade productivity for knowledge transmission. Driver = the person receiving the knowledge.
- **Delivery mode**: we trade knowledge transmission for productivity. Driver = the person with the most practice.
...
- Keep syncing up when you split. You're still working on the same task together.
