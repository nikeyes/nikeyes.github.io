---
layout: post
title: Solo el 5% de los proyectos de IA generativa crean valor real de negocio
categories:
  - GenAI
  - LLMs
...
tags:
  ...
  - Desarrollo guiado por IA
lang: es
ref: only-5-percent-ai-projects-create-business-value
published: true
---

> ”Complicar es fácil. Simplificar es dificilísimo ”  - Anónimo

Según el estudio [The GenAI Divide - State of AI in business 2025](https://mlq.ai/media/quarterly_decks/v0.1_State_of_AI_in_Business_2025_Report.pdf) del proyecto [Nanda del MIT](https://nanda.media.mit.edu/), el 95% de los proyectos de IA generativa no generan ningún impacto de negocio.
