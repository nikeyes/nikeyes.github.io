...
Aquí es donde se complica. Cada vez que el agente corre estás pagando. A veces acierta, a veces no. Y cuando no, no es un bug que apuntas en Jira: es un error que ya ha tomado decisiones y puede haber arrastrado otros errores detrás.
